  ...
  },
  {
    ...
    chapters: [
      { num: 4, title: '理解利率', emoji: '📈',
        ...
        implemented: true, pagePath: generic(4), tier: 'basic' },
      { num: 5, title: '利率行为', emoji: '⚖️',
        brief: '可贷资金 vs 流动性偏好',
        difficulty: 3, duration: '10 分钟',
        implemented: true, pagePath: generic(5), tier: 'basic' },
      { num: 6, title: '利率的风险结构与期限结构', emoji: '📊',
        brief: '收益率曲线为什么会倒挂',
        difficulty: 3, duration: '12 分钟',
        implemented: true, pagePath: generic(6), tier: 'basic' },
  ...
  },
  {
    ...
    chapters: [
      { num: 8, title: '金融结构的经济学分析', emoji: '🔍',
        ...
        difficulty: 3, duration: '10 分钟',
        implemented: true, pagePath: generic(8), tier: 'basic' },
      { num: 9, title: '银行业与金融机构的管理', emoji: '🏦',
        brief: '资产负债管理 + 流动性管理',
        difficulty: 3, duration: '12 分钟',
        implemented: true, pagePath: generic(9), tier: 'basic' },
  ...
  },
  {
    ...
    chapters: [
      { num: 13, title: '中央银行与联邦储备体系', emoji: '🏛️',
        ...
        implemented: true, pagePath: generic(13), tier: 'basic' },
      ...
      { num: 15, title: '货币政策工具', emoji: '🔧',
        ...
        difficulty: 3, duration: '12 分钟',
        implemented: true, pagePath: generic(15), tier: 'basic' },
